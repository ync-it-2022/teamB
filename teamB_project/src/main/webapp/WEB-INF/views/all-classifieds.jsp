		...
		<div class="container">
			...
			<div class="all-categories">
				...
				<ul class="all-cat-list">
					<li><a href="/mobiles.jsp">Mobiles <span class="num-of-ads">(5,78,076)</span></a></li>
					<li><a href="/electronics-appliances.jsp">Electronics & Appliances  <span class="num-of-ads">(3,66,495)</span></a></li>
					<li><a href="/real-estate.jsp">Real Estate  <span class="num-of-ads">(45,450)</span></a></li>
					<li><a href="/furnitures.jsp">Furniture    <span class="num-of-ads">(1,77,145)</span></a></li>
					<li><a href="/pets.jsp">Pets   <span class="num-of-ads">(1,81,250)</span></a></li>
					<li><a href="/books-sports-hobbies.jsp">Books, Sports & Hobbies    <span class="num-of-ads">(66,822)</span></a></li>
					<li><a href="/fashion.jsp">Fashion   <span class="num-of-ads">(29,156)</span></a></li>
					<li><a href="/kids.jsp">Kids   <span class="num-of-ads">(25,699)</span></a></li>
					<li><a href="/services.jsp">Services   <span class="num-of-ads">(2,15,895)</span></a></li>
					<li><a href="/cars.jsp">Cars   <span class="num-of-ads">(2,15,306)</span></a></li>
				</ul>
			</div>
			<div class="ads-grid">
